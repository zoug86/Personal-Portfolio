...
const Portfolio = () => {
    ...
    return (
        <Grid container spacing={3} className="section pb-45 pt-45">
            <Grid container>
            ...
            <Dialog className="project-dialog" onClose={handleClose} open={projectDialog}>
                <DialogTitle onClose={handleClose}>
                    {projectDialog.title}
                </DialogTitle>
                <img className="project-dialog-image" src={projectDialog.imageUrl} alt="" />
                ...
                <DialogActions className="project-dialog-actions">
                    {projectDialog?.links?.map(link => (
                        <a href={link.link} target="_blank" rel="noreferrer" className="project-dialog-icon">
                            {link.icon}
                        </a>
                    ))}
                </DialogActions>
